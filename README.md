...
- The AllocatorDAO Proxy configuring the different rate limits is assumed is to know what it is doing and is allowed to set any configuration, even if one configuration collides or duplicates others.
